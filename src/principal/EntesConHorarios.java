...
public abstract class EntesConHorarios {
	...
	public boolean estaDisponible(){
		return(estaDisponibleSegunLista(this.getHorariosAtencion()));	//Usa el metodo de POI (interfaz Horario), fecha=HOY
	}
	...
	public boolean estaDisponibleSegunLista(List<Horario> horariosAtencion,int dia, String hora){	//Fecha minima y maxima (Intervalo en que esta disponible el lugar).					// Si uso "hora" el lambda tira error (?) -.-
